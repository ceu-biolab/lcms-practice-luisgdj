...
public class ElutionOrderTest {
    ...
    public void score1BasedOnRTCarbonNumbers() {
        ...
        System.out.println("\nTEST 1: score1BasedOnRTCarbonNumbers:\n");
        ...
        try {
            ...
            System.out.println("\nSCORES TEST 1: "
                    + "\n - Anotation 1: " + annotation1.getScore() + " -> Normalized: " + annotation1.getNormalizedScore()
                    + "\n - Anotation 2: " + annotation2.getScore() + " -> Normalized: " + annotation2.getNormalizedScore()
                    + "\n - Anotation 3: " + annotation3.getScore() + " -> Normalized: " + annotation3.getNormalizedScore() + "\n"
            );
    ...
    public void score1BasedOnRTDoubleBonds() {
        ...
        System.out.println("\nTEST 2: score1BasedOnRTDoubleBonds:\n");
        // Assume lipids already annotated
        LOG.info("Creating RuleUnit");
        LipidScoreUnit lipidScoreUnit = new LipidScoreUnit();
        RuleUnitInstance<LipidScoreUnit> instance = RuleUnitProvider.get().createRuleUnitInstance(lipidScoreUnit);
    ...
    public void negativeScoreBasedOnRTNumberOfCarbons() {
        ...
        System.out.println("\nTEST 4: negativeScoreBasedOnRTNumberOfCarbons:\n");
        // Assume lipids already annotated
        LOG.info("Creating RuleUnit");
        LipidScoreUnit lipidScoreUnit = new LipidScoreUnit();
        RuleUnitInstance<LipidScoreUnit> instance = RuleUnitProvider.get().createRuleUnitInstance(lipidScoreUnit);
    ...
    public void negativeScoreBasedOnRTDoubleBonds() {
        ...
        System.out.println("\nTEST 5: negativeScoreBasedOnRTDoubleBonds:\n");
        // Assume lipids already annotated
        LOG.info("Creating RuleUnit");
        LipidScoreUnit lipidScoreUnit = new LipidScoreUnit();
        RuleUnitInstance<LipidScoreUnit> instance = RuleUnitProvider.get().createRuleUnitInstance(lipidScoreUnit);
    ...
    public void negativeScoreBasedOnLipidType() {
        ...
        System.out.println("\nTEST 6: negativeScoreBasedOnLipidType:\n");
        // Assume lipids already annotated
        LOG.info("Creating RuleUnit");
        LipidScoreUnit lipidScoreUnit = new LipidScoreUnit();
        RuleUnitInstance<LipidScoreUnit> instance = RuleUnitProvider.get().createRuleUnitInstance(lipidScoreUnit);
